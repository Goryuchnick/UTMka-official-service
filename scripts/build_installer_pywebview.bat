...
echo ========================================
echo Building installer (PyWebView version)
echo ========================================
echo.

REM Check if exe exists
if not exist "dist\UTMka.exe" (
    echo ERROR: File dist\UTMka.exe not found!
    echo.
    echo First run: scripts\build_pywebview.bat
    pause
    exit /b 1
)
