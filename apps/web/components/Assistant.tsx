          ...
          >
            ...
            {state !== 'member' ? (
              <div className="invite">
                <span>
                  <b>Помощнику нужна кодовая фраза.</b> Это единственное платное место в
                  инструменте, и без фразы не посчитать лимит. Всё остальное работает без входа.
                </span>
              ...
              <>
                ...
                <p className="hint">
                  ...
                  пробелы, а то, что не чинится, не показываю вовсе.
                </p>
              </>
            )}
