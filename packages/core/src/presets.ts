...
export const PRESETS: readonly Preset[] = [
  ...
  },
  {
    ...
    params: { source: 'vk', medium: 'cpc', campaign: '{campaign_name}', content: '{ad_id}' },
    explain:
      'vk — площадка, cpc — платный трафик. Для обычного поста в сообществе тип другой: social, а не cpc.',
    placeholders: [
      { token: '{campaign_id}', meaning: 'номер кампании' },
      { token: '{campaign_name}', meaning: 'название кампании из кабинета' },
      { token: '{ad_id}', meaning: 'номер объявления' },
      { token: '{ad_name}', meaning: 'название объявления' },
      { token: '{client_id}', meaning: 'номер клиента (для агентских кабинетов)' },
    ],
  },
  {
    id: 'vk-post',
